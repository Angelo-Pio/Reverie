    ...
    ElevatedCard(
        ...
        Column(Modifier.padding(12.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                UserPicture(imageUrl = userImage, Modifier.size(40.dp))
...
@Composable
fun CharmCommentWithCharm(userImage: Int, username: String, charmImage: Int = R.drawable.saint_rick) {
...
fun CharmCommentPreview() {
    ...
    LazyColumn(
        ...
        items(users) { user ->
            CharmCommentWithCharm(userImage = user, username = user.toString(), charmImage = user)
        }
    }
